...
int main(void)
{
    ...
    */
    /* `glVertexAttribPointer` is a function in OpenGL that specifies how to interpret the vertex data
    stored in a buffer. It tells OpenGL how to connect the vertex data with the vertex shader's
    input variables. */
